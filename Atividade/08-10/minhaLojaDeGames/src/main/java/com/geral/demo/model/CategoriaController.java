...
@RestController
@RequestMapping("/categoria") // Requisição
...
public class CategoriaController {
	...
	public ResponseEntity<List<Categoria>> GetByTitulo(@PathVariable String tipoJogo){
		return ResponseEntity.ok(repository.findAllBytipoJogoIgnoreCase(tipoJogo));
	}
